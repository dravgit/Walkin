...
import com.jks.walkin.BuildConfig
import com.jks.walkin.R
import com.jks.walkin.cyp.app.WalkinApplication
import com.jks.walkin.cyp.models.*
import com.jks.walkin.cyp.utils.BitmapUtils
import com.jks.walkin.cyp.utils.ByteUtil
import com.jks.walkin.cyp.utils.NetworkUtil.Companion.NetworkLisener
import com.jks.walkin.cyp.utils.NetworkUtil.Companion.checkIn
import com.jks.walkin.cyp.utils.PreferenceUtils
import com.jks.walkin.cyp.utils.SunmiUtility
import com.jks.walkin.cyp.utils.Util.Companion.createImageFromQRCode
import com.jks.walkin.cyp.wrapper.CheckCardCallbackV2Wrapper
...
//                                        });
    ...
    private fun printP2(data: CheckInResponseModel) {
        ...
        sunmiPrinterService!!.printText("\n\nบริษัท : " + PreferenceUtils.getCompanyName() +
                                                ...
                                                "\nติดต่อบ้านเลขที่ : " + data.objective_note.replace(" "," ") +
