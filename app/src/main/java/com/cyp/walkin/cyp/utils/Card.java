...
public class Card {
    ...
    public static int GetTrackData(byte[] Inbuf) {
        ...
        if ((Inbuf[iPos]) != 0) {
            ...
            Log.e("Track2: ", CommonConvert.bcdToASCString(track2,0,Inbuf[iPos]));
        ...
        if (Inbuf[iPos] != 0) {
            ...
            Log.e("Track3: ", CommonConvert.bytesToString(track3,0,Inbuf[iPos]));
        ...
        if (Inbuf[iPos] != 0) {
			...
			Log.e("Track1: " , CommonConvert.bytesToString(track1,0,Inbuf[iPos]));
